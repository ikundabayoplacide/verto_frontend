  ...
  return (
    <section id="why-us" className="relative  bg-secondary-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mt-6 mb-4 lg:px-10 relative">
        <div>
          <span data-reveal className="flex items-center gap-3 mb-4">
          ...
          <h2 data-reveal className="text-4xl md:text-5xl font-black text-primary-900 uppercase tracking-tight leading-[0.95] mb-14">
