...
function PlanFab() {
  return (
    ...
    >
      <span className="grid place-items-center w-9 h-9 rounded-full bg-primary-500 text-white">
        <IconChat />
      </span>
      <span className="text-sm font-semibold text-primary-900">Plan Your Event</span>
      <span className="text-[10px] font-semibold uppercase text-primary-500 bg-primary-50 rounded-full px-2 py-0.5">Beta</span>
    </Link>
  );
}
